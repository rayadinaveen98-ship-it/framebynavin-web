  ...
  return (
    <main>
      ...
      <section className="section shell media-kit">
        ...
        <div className="media-card"><span>FRAMEBYNAVIN / MEDIA KIT</span><div className="media-metrics">{metrics.map((m) => <p key={m.label}><b>{m.value}</b>{m.label}</p>)}</div><a href="#contact">OPEN MEDIA KIT <Arrow /></a></div>
      </section>
      ...
      <section id="contact" className="cta shell">
        <p className="eyebrow">07 / START A PROJECT</p><h2>Have something<br/>worth building?</h2><p>Brand, film, product or an unusual creative idea — send the brief.</p><a className="button button-primary" href="mailto:hello@framebynavin.com">LET&apos;S WORK <Arrow /></a>
      </section>
